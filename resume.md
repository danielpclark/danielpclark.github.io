...
* <b>Performance & Safety:</b> Leverages Rust’s memory safety while enabling Ruby extensions without needing C bindings.
...
For my development work, I’ve integrated AI-assisted tooling into my workflow, leveraging GitHub Copilot alongside Claude Sonnet as a form of pair programming. This approach has significantly accelerated my output—enabling up to a 5× increase in development speed—particularly when working with well-defined application context and delivering pull requests efficiently.

I also designed and built a custom application and AI-driven service architecture that automated the creation, sequencing, and rendering of storytelling videos for TikTok. The system integrated multiple AI providers (including language, image, video, and audio generation tools) and evolved from an initial monolithic implementation into a distributed microservices architecture comprising 10 services. It utilized a backend that transitioned from Google Sheets and Drive to a Postgres database, all orchestrated through a locally hosted <a href="https://n8n.io">n8n</a> environment. A key focus of this project was optimizing for cost efficiency and resilience, given the compounding financial impact of failures across AI processing pipelines. This was developed as a personal project.
...
Contributed to <b>charity-driven Rails development projects</b>, collaborating with teams to build <b>mission-critical applications</b> that support education, conservation, and community-driven initiatives.
...
* <b>2016 – Real-Time Poker Game Server (Solo Project):</b>
  ...
  * <b>Game tables, seat assignments, and card dealing</b>
